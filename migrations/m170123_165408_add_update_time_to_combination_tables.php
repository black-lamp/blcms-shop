...
class m170123_165408_add_update_time_to_combination_tables extends Migration
{
    ...
    private function setsTimeColumns() {
        ...
        $models = [
            '\bl\cms\shop\common\entities\Combination', '\bl\cms\shop\common\entities\CombinationAttribute',
            '\bl\cms\shop\common\entities\CombinationImage', '\bl\cms\shop\common\entities\CombinationPrice',
            '\bl\cms\shop\common\entities\CombinationTranslation'
        ];
