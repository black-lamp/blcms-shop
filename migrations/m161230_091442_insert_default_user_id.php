...
class m161230_091442_insert_default_user_id extends Migration
{
    public function up()
    {
        $this->insert('user_group', [
            'id' => \bl\cms\shop\common\components\user\models\UserGroup::USER_GROUP_ALL_USERS
        ]);
        $this->insert('user_group_translation', [
            'user_group_id' => \bl\cms\shop\common\components\user\models\UserGroup::USER_GROUP_ALL_USERS,
