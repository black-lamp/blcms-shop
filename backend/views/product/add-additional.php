 ...
 *
 * @var $additionalProductsCategories \bl\cms\shop\common\entities\Category
 * @var $productAdditionalProducts \bl\cms\shop\common\entities\Product
        ...
        <table class="table table-hover" id="additional-products-table">
            ...
            <?php foreach ($productAdditionalProducts as $productAdditionalProduct) : ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= Url::to(['/shop/product/remove-additional-product', 'id' => $productAdditionalProduct->id]); ?>"
