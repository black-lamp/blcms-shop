 ...
 * @var $relatedProducts \bl\cms\shop\common\entities\RelatedProduct[]
 * @var $newRelatedProduct \bl\cms\shop\common\entities\RelatedProduct
                ...
                <tr>
                    <td>
                        <?= $form->field($newRelatedProduct, 'related_product_id')
                            ->dropDownList(ArrayHelper::map($products, 'id', 'translation.title'))->label(false);
                        ?>
                    </td>
                    <td>
